...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if ( !DatabaseConnection.instance ) {
      ...
      console.log('%cLa conexion ha sido creada', COLORS.orange);
    }
  ...
  public connect(): void {
    ...
    if ( this.connected ) {
      console.log('%cYa cuenta con una conexion activa', COLORS.yellow);
      return;
    }

    this.connected = true;
    console.log('%cConexión activa', COLORS.green);
  ...
  public disconnect(): void {
    ...
    if ( !this.connected ) {
      console.log('%cNo hay una conexión activa', COLORS.yellow);
      return;
    }

    this.connected = false;
    console.log('%cSe ha desconectado la base de datos', COLORS.red);
  }
}
